...
\end{equation}
Thus, once $a$ is chosen, the value of $b$ is uniquely determined. Figure~\ref{fig:visualize_demand_curve} shows the resulting schedules for the seven values of $a$ used in our experiments. Smaller values of $a$ produce increasing-demand scenarios ($b>0$), larger values produce decreasing-demand scenarios ($b<0$), and $a=1000$ gives the constant-demand case.
